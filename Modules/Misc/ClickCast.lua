...
local function load()
    ...
    if not Y.IsMainline then
        SpellBinder:SetPoint('TOPLEFT', SpellBookFrame, 'TOPRIGHT', 32, -15)
        SpellBinder:SetHeight(420)
    else
        SpellBinder:SetPoint('TOPLEFT', SpellBookFrame, 'TOPRIGHT', 100, -1)
    end
    SpellBinder:Hide()
    SpellBinderPortrait:SetTexture([[Interface\Spellbook\Spellbook-Icon]])
    ...
    SpellBinder.title:SetText(L['Click Cast Bindings'])
    ...
    for _, v in pairs({'PlayerFrame', 'PetFrame', -- Party members
    'PartyMemberFrame1', 'PartyMemberFrame2', 'PartyMemberFrame3', 'PartyMemberFrame4', 'PartyMemberFrame5', -- Party pets
    'PartyMemberFrame1PetFrame', 'PartyMemberFrame2PetFrame', 'PartyMemberFrame3PetFrame', 'PartyMemberFrame4PetFrame', 'PartyMemberFrame5PetFrame', -- Compact party member frame
    'CompactPartyFrameMemberSelf', 'CompactPartyFrameMemberSelfBuff1', 'CompactPartyFrameMemberSelfBuff2', 'CompactPartyFrameMemberSelfBuff3', 'CompactPartyFrameMemberSelfDebuff1', 'CompactPartyFrameMemberSelfDebuff2',
                       'CompactPartyFrameMemberSelfDebuff3', 'CompactPartyFrameMember1Buff1', 'CompactPartyFrameMember1Buff2', 'CompactPartyFrameMember1Buff3', 'CompactPartyFrameMember1Debuff1', 'CompactPartyFrameMember1Debuff2',
                       'CompactPartyFrameMember1Debuff3', 'CompactPartyFrameMember2Buff1', 'CompactPartyFrameMember2Buff2', 'CompactPartyFrameMember2Buff3', 'CompactPartyFrameMember2Debuff1', 'CompactPartyFrameMember2Debuff2',
                       'CompactPartyFrameMember2Debuff3', 'CompactPartyFrameMember3Buff1', 'CompactPartyFrameMember3Buff2', 'CompactPartyFrameMember3Buff3', 'CompactPartyFrameMember3Debuff1', 'CompactPartyFrameMember3Debuff2',
                       'CompactPartyFrameMember3Debuff3', 'CompactPartyFrameMember4Buff1', 'CompactPartyFrameMember4Buff2', 'CompactPartyFrameMember4Buff3', 'CompactPartyFrameMember4Debuff1', 'CompactPartyFrameMember4Debuff2',
                       'CompactPartyFrameMember4Debuff3', 'CompactPartyFrameMember5Buff1', 'CompactPartyFrameMember5Buff2', 'CompactPartyFrameMember5Buff3', 'CompactPartyFrameMember5Debuff1', 'CompactPartyFrameMember5Debuff2',
                       'CompactPartyFrameMember5Debuff3', -- Target and focus frames
    'TargetFrame', 'TargetFrameToT', 'FocusFrame', 'FocusFrameToT', -- Boss and arena frames
    'Boss1TargetFrame', 'Boss2TargetFrame', 'Boss3TargetFrame', 'Boss4TargetFrame', 'ArenaEnemyFrame1', 'ArenaEnemyFrame2', 'ArenaEnemyFrame3', 'ArenaEnemyFrame4', 'ArenaEnemyFrame5'}) do
        if _G[v] then
    ...
    SpellBinder.makeFramesList = function()
        for frame in pairs(ClickCastFrames) do
            ...
            if v ~= 'YxUI Player' and v ~= 'YxUI Target' then
    ...
    SpellBinder.OpenButton:SetScript('OnShow', function(self)
        ...
        self:SetScript('OnEnter', function(self)
            ...
            GameTooltip:AddLine(L_MISC_BINDER_OPEN)
            GameTooltip:Show()
        end)
    ...
    local addSpell = function(self, button)
        if SpellBinder.sbOpen then
            ...
            if spellname ~= 0 and ((SpellBookFrame.bookType == BOOKTYPE_PET) or (SpellBookFrame.selectedSkillLine > 1)) then
                ...
                if not Y.IsMainline and strlen(spellrank) > 0 then
    ...
    YxUIData.ClickCast = YxUIData.ClickCast or {}
    YxUIData.ClickCast[Y.UserProfileKey] = YxUIData.ClickCast[Y.UserProfileKey] or {}
    DB = YxUIData.ClickCast[Y.UserProfileKey]
    ...
    C_Timer.After(0.5, SpellBinder.UpdateAll)
...
Module:Add('misc-click-cast', true, L['Enable Click Cast'], L['Cast spell for mouse click'], function(self, enable)
    if enable then
        load()
    end
end, true)
